...
`
const FromToIcons = tw.div` w-w10  flex flex-col mr-2 items-center
`
...
`
const Input = tw.input` h-10 bg-gray-200 my-2 rounded-2 p-2 outline-none border
`
...
`
const ConfirmButton = tw.div` bg-black text-white text-center mr-2 mx-4 py-4 text-2xl cursor-pointer
`
